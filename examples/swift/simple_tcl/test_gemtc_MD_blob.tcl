...
puts "Size of Long Int is: $sizeOfLongInt"
puts "Size of Double is: $sizeOfDouble"

set h_np_ptr [ GEMTC_CPUMalloc $sizeOfLongInt ]
set h_nd_ptr [ GEMTC_CPUMalloc $sizeOfLongInt ]
set h_mass_ptr [ GEMTC_CPUMalloc $sizeOfDouble ]
...
set h_posArray_ptr [ GEMTC_GetPositionArray $h_a_size_value ]
set h_dummyArray_ptr [ GEMTC_GetDoubleArray $h_a_size_value ] 
