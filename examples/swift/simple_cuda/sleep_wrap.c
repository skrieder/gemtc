...
#define SWIG_init    Tclsleep_Init
#define SWIG_name    "sleep"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_c_sleep(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:c_sleep i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "c_sleep" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  c_sleep(arg1);
...
SWIGINTERN int
_wrap_sleep_wrapper(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sleep_wrapper i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "sleep_wrapper" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  sleep_wrapper(arg1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "c_sleep", (swig_wrapper_func) _wrap_c_sleep, NULL},
    { SWIG_prefix "sleep_wrapper", (swig_wrapper_func) _wrap_sleep_wrapper, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Sleep_SafeInit(Tcl_Interp *interp) {
