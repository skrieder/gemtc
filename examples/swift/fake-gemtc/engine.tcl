...
namespace eval turbine {
	...
	# Should call once per node at the start.
        GEMTC_Setup 2560

	#GEMTC_BlockingRun
	#GEMTC_Push Type Threads ID *d_params
	#GEMTC_Poll (*GEMTC_Poll)
	#GEMTC_GPUMalloc size (*GEMTC_GPUMalloc())
	#GEMTC_GPUFree *p
	#GEMTC_MemcpyDeviceToHost *device *host size
	#GEMTC_MemcpyHostToDevice *host *device size
	
	# Should call once per node at the end of all nodes.
	GEMTC_Cleanup
