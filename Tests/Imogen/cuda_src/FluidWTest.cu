/*
 * Benchmarking code for Imogen's ported cukern_Wstep_hydro_uniform() kernel from "gpuImogen/gpuclass/cudaFluidW.cu" 
 */
#include "../../../gemtc.cu"
#include<stdio.h>
#include<stdlib.h>
...
int main(int argc, char **argv){
     ...
     * There are 6 double variables, 12 cubical data variables and 1 variable of 2 dimention.
     */
    ...
    *rhomin = 1e-5;
	 ...
	 */
        for (i = 0; i < LOOP_SIZE; i++) {
            // Memory leaks debugging in GeMTC
	     ...
	     */
            ...
            /*
             * 27 is the FluidW kernel
             */
            gemtcPush(27, 32, i+j*LOOP_SIZE, d_params);
            //gemtcPush(27, 32, i, d_params);
