...
#define SWIG_init    Hist_Init
#define SWIG_name    "hist"
#define SWIG_prefix  ""
...
_wrap_hist(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:hist h_data byteCount ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGEXPORT int Hist_SafeInit(Tcl_Interp *interp) {
