...
proc main-call_sync-hist { stack } {
    # Var: $void optv:s VALUE_OF [void:s]
    set optv:s [ hist 5 1 ]
}


proc f:hist { stack u:s u:i u:j dr:location } {
    turbine::c::log "enter function: hist"
    turbine::read_refcount_incr ${u:i} 1
    turbine::read_refcount_incr ${u:j} 1
    turbine::rule [ list ${u:i} ${u:j} ] "hist-argwait ${stack} ${u:s} ${u:j} ${u:i}" target ${dr:location} type ${::turbine::WORK}
}


proc hist-argwait { stack u:s u:j u:i } {
