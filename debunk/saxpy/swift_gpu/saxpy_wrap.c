...
#define SWIG_init    Tclsaxpy_Init
#define SWIG_name    "saxpy"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_c_saxpy(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:c_saxpy i j ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "c_saxpy" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  result = (int)c_saxpy(arg1,arg2);
...
SWIGINTERN int
_wrap_cuda_saxpy_launcher(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:cuda_saxpy_launcher i j ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cuda_saxpy_launcher" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "cuda_saxpy_launcher" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  cuda_saxpy_launcher(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "c_saxpy", (swig_wrapper_func) _wrap_c_saxpy, NULL},
    { SWIG_prefix "cuda_saxpy_launcher", (swig_wrapper_func) _wrap_cuda_saxpy_launcher, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Saxpy_SafeInit(Tcl_Interp *interp) {
