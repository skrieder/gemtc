...
Accelerators allow the machine to offload work from the CPU to the Accelerator. The Accelerator then completes the computation and returns the solution back to the host CPU. \cite{kriederSC12}
